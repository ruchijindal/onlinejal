 ...
 * @author smp
 */
public class CancelRevenueReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (o != null) {
                ...
                response.sendRedirect("jsppages/reports/revenuereport.jsp");
            ...
            response.sendRedirect("jsppages/reports/cons_report.jsp");
        }
    }
