...
public class LedgerCalculation {
    ...
    Calendar due_dt = new GregorianCalendar();
    int calmonth;
    ResultSet rs = null;
    ...
    public ArrayList<ArrayList> insblPeriodCl(String cons_no, Calendar billdate, String sec, String xmlpath) throws SQLException {
...
//       con=dataSource.getConnection();
    ...
    public ArrayList<ArrayList> updChlDetCl(String cons_no, Calendar billdate, String sec, String xmlpath) throws SQLException {
        cons_nm1 = null;
        cons_nm2 = null;
        con_tp = null;
        cons_ctg = null;
        ...
        try {
            ...
            System.out.println("Exception in update challan in BillCalculation1:" + ex);
        }

        return al;
    }

    public ArrayList<ArrayList> calbillCl(String cons_no, Calendar billdate, String sec, String xmlpath) {
        ...
        try {
            ...
            java.sql.Date cal_dt1 = null;
            while (rs.next()) {
                System.out.println("inside if======>");
                cal_dt1 = rs.getDate(14);
            }
            if (cal_dt1 == null) {
                alrow = new ArrayList();
                alrow.add(0, "N/A");
                ...
                for (int a = 0; a < al.size(); a++) {
                    ...
                    System.out.println("Calculated Bill Amount=" + bill_amt);
                     ...
                     */
                    double reb=0.0;
                    if (((due_dt.after(new GregorianCalendar(due_dt.get(Calendar.YEAR), 3, 1)) && due_dt.before(new GregorianCalendar(due_dt.get(Calendar.YEAR), 4, 1))) || due_dt.equals(new GregorianCalendar(due_dt.get(Calendar.YEAR), 3, 30)))) {
                        reb = 10;
                    } else if ((due_dt.after(new GregorianCalendar(due_dt.get(Calendar.YEAR), 3, 30)) && due_dt.before(new GregorianCalendar(due_dt.get(Calendar.YEAR), 5, 1)) || due_dt.equals(new GregorianCalendar(due_dt.get(Calendar.YEAR), 4, 31)))
                            && (bill_cycle == 2 || bill_cycle == 4 || bill_cycle == 1)) {
                        reb = 10;
                    } else if (((due_dt.after(new GregorianCalendar(due_dt.get(Calendar.YEAR), 4, 31)) && due_dt.before(new GregorianCalendar(due_dt.get(Calendar.YEAR), 9, 1))) || due_dt.equals(new GregorianCalendar(due_dt.get(Calendar.YEAR), 8, 30)))
                            && (bill_cycle == 2 || bill_cycle == 1)) {
                        reb = 5;
                    } else {
                        reb = 0;
                    }
                    ...
                    //System.out.println("hiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii"+formatter.format(due_dt.getTime()));
                    ...
                    amt = df.format(Math.ceil(arrear + cssarrear-reb));
                    alrow.add(0, amt);
                     alrow.add(1,formatter.format(due_dt.getTime()));
                    alrow.add(20, credit);
...
//                    System.out.println("totalamt=" + totamt);
//                    System.out.println("totalamtpaid=" + totpaidamount);
//                    System.out.println("principal=" + principle);
//                    System.out.println("currentamt=" + currentamt);
//                    System.out.println("cssarrear=" + cssarrear);
//                    System.out.println("csscredit=" + csscredit);
