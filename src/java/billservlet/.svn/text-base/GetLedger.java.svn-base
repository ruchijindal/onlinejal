...
public class GetLedger extends HttpServlet {
    ...
    public class MyPdf implements Runnable {
        ...
        MyPdf(String cons, Calendar bdate, String sec1, String xpath) {
            cons_no = cons;
            billdate = bdate;
            sec = sec1;
            xmlpath = xpath;
        ...
        public void run() {
            try {
                ...
                System.out.println("Exception in ledger:" + ex);
...
//            }
            ...
            if (o == null) {
                pdf = new MyPdf(cons_no, billdate, sec, xmlpath);
            ...
            switch (pdf.getPercentage()) {
                ...
                case 1:
                    alsec = pdf.calAl();
                    context = getServletContext();
                    String path = context.getRealPath("") + "/resources/ledger/" + userid + ".xml";
                    ...
                    for (int j = 0; j < r; j++) {
                        ...
                        w.println("<challan>");
                        dt = (java.sql.Date) alrow.get(11);
                        if (dt == null) {
                            bl_per_fr = " ";
                        } else {

                            formatter = new SimpleDateFormat("dd-MM-yy");
                            bl_per_fr = formatter.format(dt);
                        ...
                        dt = (java.sql.Date) alrow.get(12);
                        if (dt == null) {
                            bl_per_to = " ";
                        } else {

                            formatter = new SimpleDateFormat("dd-MM-yy");
                            bl_per_to = formatter.format(dt);
                        ...
                        dt = (java.sql.Date) alrow.get(17);
                        if (dt == null) {
                            pay_date = "  ";
                        } else {

                            formatter = new SimpleDateFormat("dd-MM-yy");
                            pay_date = formatter.format(dt);
                    ...
                    out.println(bl_per_to+":"+principal+":"+interest+":"+arrear+ ":" + path);
