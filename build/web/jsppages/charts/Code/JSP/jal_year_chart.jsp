...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <title>Noida Jal Board : Revenue Collection Details</title>
                ...
                <div class="container">
					...
					<<div class="tab-content default-tab" id="tab1">-->
                                ...
                                <div id="table-blk" class="full">
                                    <h2>Year Wise Revenue Collection Chart for JAL</h2>
                                    <div class="buttons">
                                    ...
                                    <h4>As on <%=update_dt%></h4>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            myExportComponent.sourceCharts = ['JAL1','JAL2','JAL3'];
                                            ...
                                            //Default file name.
                                            myExportComponent.componentAttributes.defaultExportFileName = 'Year Wise Revenue Chart';
                                            //Width and height
                                    ...
                                    <%
                                                ...
                                                for (int j = 1; j < nl1.getLength(); j = j + 2) {
                                                    ...
                                                    strXML = "";
                                                    strXML = "<chart caption='Year Wise Revenue Collection Details of " + division.toUpperCase() + "' xAxisName='Year' yAxisName='Paid Amount (in Lakhs)' bgcolor='#F0F0F0' showBorder='0' showFCMenuItem='0' formatNumberScale='2' numberSuffix='' Unitsanimation='" + animateChart + "' decimalPrecision='3' formatNumberScale='0'  rotatevalues='1' placevaluesinside='1' labelDisplay='Rotate' slantLabels='1' exportEnabled='1' exportAtClient='1' exportHandler='fcBatchExporter' bgcolor='FBFBFB' showToolTipShadow='1' showAboutMenuItem='0'>";
                                    ...
                                    %>
                    <br class="clear"/>                <jsp:include page="Includes/FusionChartsRenderer.jsp">
                                        <jsp:param name="chartSWF" value="../FusionCharts/Column3D.swf" />
                                        <jsp:param name="strURL" value="" />
                                        <jsp:param name="strXML" value="<%=strXML%>" />
                                        <jsp:param name="chartId" value="<%=c_id%>" />
