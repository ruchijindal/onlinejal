    ...
    <body>
        ...
        <%
                    try {
                        ...
                        sql = "select to_char(con_date,'Month yyyy') from jal_content  where content_type='news' and to_char(con_date,'dd-mm-yyyy') like '__-" + month + "-" + year + "'";
            ...
            <div class="inside">
                <div class="container">
                    <div id="breadcrumb">
                        ...
                        <div class="inactive">
                            <a href="news_list.jsp" title="News">
                                <span class="leftcorners">
                                    <span class="rightarrow">
                                        <span class="bg">
                                            News
                                            ...
                                            <div class="insider">
                                                <div class="article">
                                                    ...
                                                    <div class="inside">
                                                        <div class="container">
                                                            <div id="contentrail">
                                                                <h2>News</h2><div class="dt right"><%=mon%></div>
                                                                <div class="article">
                                                                    ...
                                                                    <%
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    sql = "select con_id,con_title,content_type, to_char(con_date,'dd Mon,yy') from jal_content where content_type='news' and to_char(con_date,'dd-mm-yyyy') like '__-" + month + "-" + year + "' order by con_date desc";
                                                                                    sql1 = "select count(*) from jal_content  where content_type='news' and to_char(con_date,'dd-mm-yyyy') like '__-" + month + "-" + year + "'";
                                                                    ...
                                                                    <div class="infobar no">
                                                                        ...
                                                                        <div class="button ">
                                                                            <a href="news.jsp?con_id=<%=con_id%>&amp;month=<%=month%>" title="Read more">
                                                                ...
                                                                <div class="paging p1">
                                                                    <ul>
                                                                        ...
                                                                        %>
                                                                        <li class="first">
                                                                            <a href="monthnews.jsp?month=<%=month%>&amp;year=<%=year%>&amp;startIndex=1&amp;pflag=1&amp;numRows=<%=numRows%>" title="First Page">
                                                                        ...
                                                                        <li class="previous">
                                                                            <a href="monthnews.jsp?month=<%=month%>&amp;year=<%=year%>&amp;startIndex=<%=startIndex - numRecordsPerPage%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Previous Page">
                                                                                <span class="leftcornerss">
                                                                                    <span class="rightcornerss">
                                                                                        <span class="bgs">
...
%>
                                                                        <li class=<%=a%>>
                                                                            <a href="monthnews.jsp?month=<%=month%>&amp;year=<%=year%>&amp;startIndex=<%=(j - 1) * numRecordsPerPage + 1%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="1">
                                                                                <span class="leftcornerss">
                                                                                    <span class="rightcornerss">
                                                                                        <span class="bgs">
                                                                                            <%=j%>
                                                                        ...
                                                                        <%if (startIndex + numRecordsPerPage < numRows) {%>
                                                                        <li class="next">
                                                                            <a href="monthnews.jsp?month=<%=month%>&amp;year=<%=year%>&amp;startIndex=<%=startIndex + numRecordsPerPage%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Next Page">
                                                                                <span class="leftcornerss">
                                                                                    <span class="rightcornerss">
                                                                                        <span class="bgs">
                                                                        ...
                                                                        <li class="last">
                                                                            <a href="monthnews.jsp?month=<%=month%>&amp;year=<%=year%>&amp;startIndex=<%=numRows - remain + 1%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Last Page">
                                                                                <span class="leftcornerss">
                                                                                    <span class="rightcornerss">
                                                                                        <span class="bgs">
                                                                        ...
                                                                        %>
                                                                        <li class="last">
                                                                            <a href="monthnews.jsp?month=<%=month%>&amp;year=<%=year%>&amp;startIndex=<%=numRows - numRecordsPerPage + 1%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Last Page">
                                                                                <span class="leftcornerss">
                                                                                    <span class="rightcornerss">
                                                                                        <span class="bgs">
                                                                                            <img src="../../resources/images/icons/Last3.png"   class="im" alt="first" title="Last"></img>
