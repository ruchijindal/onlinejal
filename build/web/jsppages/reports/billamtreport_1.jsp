                                                    ...
                                                    <fieldset>
                                                        <ul>
                                                            <li><table>
                                                                    ...
                                                                    <tr>
                                                                        <div class="inputbox">
                                                                            <td><label class="form-label">Date<span class="required">*</span></label></td>
                                                                            <td><select name="dt_mon" id="dt_mon">
                                                                                ...
                                                                                </select><select name="dt_yr" id="dt_yr">
                                                                                    <%                for (int c = 1990; c < 2050; c++) {
                                                                                    %>
                                    ...
                                    <div class="rightcorners">
                                        <div class="bg">
                                            <div class="insider">
                                                ...
                                                <form id="reportform" action="/OnlineJal_Example/ArrearReport">
                                                    <fieldset>
                                                        <ul>
                                                            <li><table>
                                                                    <tr>
