                                ...
                                <div class="insider">
                                    ...
                                    <div class="paging p1">
                                        <ul>
                                            ...
                                            %>
                                            <li class="first">
                                                <a href="news_list.jsp?startIndex=1&amp;pflag=1&amp;numRows=<%=numRows%>" title="First Page">
                                            ...
                                            <li class="previous">
                                                <a href="news_list.jsp?startIndex=<%=startIndex - numRecordsPerPage%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Previous Page">
                                                    <span class="leftcornerss">
                                                        <span class="rightcornerss">
                                                            <span class="bgs">
                                            ...
                                            %>
                                            <li class="<%=a%>">
                                                <a href="news_list.jsp?startIndex=<%=(j - 1) * numRecordsPerPage + 1%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="1">
                                                    <span class="leftcornerss">
                                                        <span class="rightcornerss">
                                                            <span class="bgs">
                                                                <%=j%>
                                            ...
                                            <%if (startIndex + numRecordsPerPage <= numRows) {%>
                                            <li class="next">
                                                <a href="news_list.jsp?startIndex=<%=startIndex + numRecordsPerPage%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Next Page">
                                                    <span class="leftcornerss">
                                                        <span class="rightcornerss">
                                                            <span class="bgs">
                                            ...
                                            <li class="last">
                                                <a href="news_list.jsp?startIndex=<%=numRows - remain + 1%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Last Page">
                                                    <span class="leftcornerss">
                                                        <span class="rightcornerss">
                                                            <span class="bgs">
                                            ...
                                            %>
                                            <li class="last">
                                                <a href="news_list.jsp?startIndex=<%=numRows - numRecordsPerPage + 1%>&amp;pflag=1&amp;numRows=<%=numRows%>" title="Last Page">
                                                    <span class="leftcornerss">
                                                        <span class="rightcornerss">
                                                            <span class="bgs">
                                                                <img src="../../resources/images/icons/Last3.png"   class="im" alt="first" title="Last"></img>
