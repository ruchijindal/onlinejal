...
<%
            ...
            try {
                ...
                if (filename.equals("")) {
                    ...
                    sql = "update upload_file set heading='" + heading + "',description='" + description + "',path='" + path + "' where id=" + id1 + "";
                ...
                if (flag == 1) {
                    sql = "update upload_file set heading='" + heading + "',description='" + description + "' where id=" + id1 + "";
