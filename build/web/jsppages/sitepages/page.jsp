...
%>
  <%
                    try {
                        ...
                        sql = "select con_id,con_title,content,content_type,con_date from jal_content where content_type='page' and con_id='" + con_id + "'";
...
<jsp:include page="../common/header.jsp"/>
   ...
   <title>Noida Jal Board : <%=con_title%></title></head>
